...
namespace ServicioEmpleosChile
{
    public class wsServicioEmpleosChile : IServicioEmpleosChile
    {
        ...
        public ServicioEmpleosChile DelTagOficioUsuario(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.DelTagOficioUsuario(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;
        ...
        public ServicioEmpleosChile GetMensajesOficios(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.GetMensajesOficios(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;
        ...
        public ServicioEmpleosChile GetOficios(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.GetOficios(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;
        ...
        public ServicioEmpleosChile GetOficiosUsuarioFiltro(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.GetOficiosUsuarioFiltro(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;
        ...
        public ServicioEmpleosChile GetUsuariosConOficios(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.GetUsuariosConOficios(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;
        ...
        public ServicioEmpleosChile GetTagOficio(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.GetTagOficio(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;

            return IService;
        }

        public ServicioEmpleosChile GetTagOficioUsuario(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.GetTagOficioUsuario(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;
        ...
        public ServicioEmpleosChile GetDescripcionOficio(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.GetDescripcionOficio(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;

            return IService;
        }

        public ServicioEmpleosChile GetValoracionOficio(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.GetValoracionOficio(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;

            return IService;
        }

        public ServicioEmpleosChile GetComentarioOficio(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.GetComentarioOficio(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;

            return IService;
        }

        public ServicioEmpleosChile GetComentariosOficiosUsuarioLog(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.GetComentariosOficiosUsuarioLog(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;
        ...
        public ServicioEmpleosChile SetComentarioUsuarioOficios(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.SetComentarioUsuarioOficios(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;
        ...
        public ServicioEmpleosChile SetMensajesAOtrosUsuarios(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.SetMensajesAOtrosUsuarios(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;
        ...
        public ServicioEmpleosChile SetTagOficio(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.SetTagOficio(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;

            return IService;
        }

        public ServicioEmpleosChile SetTagOficioUsuario(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.SetTagOficioUsuario(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;

            return IService;
        }

        public ServicioEmpleosChile SetDescripcionOficio(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.SetDescripcionOficio(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;

            return IService;
        }

        public ServicioEmpleosChile SetValoracionOficio(string[] Parametros, string[] Valores)
        {
            CEmpleosChile EChile = new CEmpleosChile();
            ServicioEmpleosChile IService = new ServicioEmpleosChile();
            DataSet ds = new DataSet();

            ds.Tables.Add(EChile.SetValoracionOficio(ArrayToListParametros(Parametros, Valores)));
            IService.Table = ds;
